...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self,lane,vehicleClass,direction_number,direction,will_turn):
        ...
        try:
            ...
            # For vertical travel (up/down) swap to portrait orientation
            # so vehicles are narrow (fits in lane) rather than wide (causes overlap)
